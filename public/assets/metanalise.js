...
(function () {
  ...
  var PROGRESS = [
    ...
    { v: 1089, kind: 'marco', tKey: 'marcoUnidadeCo2' }
  ];
  ...
  var COPY = {
    ...
    ZH: {
      ...
      progressMarcos: {
        ...
        marcoUnidadeCo2: '<b>修正 · 2026.09.08</b><br>并非所有提取的CO₂单位都是kg CO₂-eq/m³：部分数据行使用的是已按MPa归一化的指标，或按平方米、吨、整个构件等单位给出的数值，此前被当作kg/m³直接绘制。这些数据行将从图表中移除，直到逐篇文献确认为止——见下方"报告的CO₂单位"。<br><b>1,309 → 1,089</b> 对数据。'
      },
      scatterTitle: '强度 × 碳足迹',
