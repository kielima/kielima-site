...
(function () {
  ...
  var COPY = {
    PT: {
      ...
      f_co2u: 'Unidade',
      f_co2f: 'Fonte no PDF',
      f_co2orig: 'Valor publicado',
      f_co2loc: 'Local no PDF',
      f_co2conv: 'Conversão',
      f_co2m3: 'CO₂ (kg/m³) — base dos gráficos',
      secInd: 'Indicadores',
      f_ci: 'ci (kg CO₂-eq/MPa)',
      f_cit: 'cit (kg CO₂-eq/(MPa·ano))',
      f_vol: 'Volume (m³)',
    ...
    EN: {
      ...
      f_co2orig: 'Published value',
      f_co2loc: 'Location in the PDF',
      f_co2conv: 'Conversion',
      f_co2m3: 'CO₂ (kg/m³) — basis of the charts',
      secInd: 'Indicators',
      f_ci: 'ci (kg CO₂-eq/MPa)',
      f_cit: 'cit (kg CO₂-eq/(MPa·year))',
      f_vol: 'Volume (m³)',
    ...
    ZH: {
      ...
      f_co2loc: 'PDF 中的位置',
      f_co2conv: '换算方法',
      f_co2m3: 'CO₂（kg/m³）——图表基准',
      secInd: '指标',
      f_ci: 'ci（kg CO₂-eq/MPa）',
      f_cit: 'cit（kg CO₂-eq/(MPa·年)）',
      f_vol: '体积 (m³)',
      f_volf: '体积来源',
      f_volc: '引文',
      f_dur: '摘要',
  ...
  var SECOES = [
    ...
    ['secCo2', [['co2_original', 'f_co2orig'], ['co2_original_local', 'f_co2loc'], ['co2_conversao', 'f_co2conv'], ['co2_kg_m3', 'f_co2m3']]],
    ['secInd', [['ci_kgco2_mpa', 'f_ci'], ['cit_kgco2_mpa_ano', 'f_cit']]],
